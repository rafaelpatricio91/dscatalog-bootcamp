...
import com.rafa.dscatalog.services.ProductService;
...
public class ProductResource {
	...
	public ResponseEntity<ProductDTO> findById(@PathVariable Long id) {
		ProductDTO category = new ProductDTO();
	...
	@PostMapping
	public ResponseEntity<ProductDTO> insert(@RequestBody ProductDTO cat) {
